...
<script src="https://kit.fontawesome.com/e48a00faf1.js"
...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<c:if test="${not empty sessSeq}">
						<li class="dropdown"><a href="#"><span>내 정보 </span> <i
								class="bi bi-chevron-down dropdown-indicator"></i></a>
							<ul>
								<li><a
									href="/user/userMod?seq=<c:out value="${item.seq}"/>">기본정보</a></li>
	...
	<main id="main">
		...
		<div class="breadcrumbs d-flex align-items-center"
			style="background-image: url('../resources/images/book.jpg');">
			<div
				class="container position-relative d-flex flex-column align-items-center aos-init aos-animate"
				data-aos="fade">
		...
		<section id="blog" class="blog">
			<form method="post" name="form">
				<input type="hidden" name="fvseq" id="fvseq"
					value="<c:out value="${item.fvseq}"/>" />
							...
							<c:forEach items="${listBook}" var="list" varStatus="status">
								<div class="post-item position-relative h-100">
									<div class="post-images position-relative overflow-hidden">
										<img src="../resources/images/pachinko.jpg"
											style="width: 350px; height: 500px;">
									</div>

									<div class="post-content d-flex flex-column">
										<h3 class="post-title">
											<c:out value="${list.fvName}" />
										</h3>
										<div class="meta d-flex align-items-center">
											<div class="d-flex align-items-center">
												<i class="bi bi-person"></i> <span class="ps-2"><c:out
														value="${list.writerName}" /></span>
											</div>
											<span class="px-3 text-black-50">/</span>
											<div class="d-flex align-items-center">
												<i class="bi bi-folder2"></i> <span class="ps-2"><c:out
														value="${list.fvPublisher}" /></span>
											</div>
										</div>
										<br>
										<a href="/book/like1" class="readmore stretched-link"><span>Read
	...
	<footer id="footer" class="footer">
		<div class="footer-legal text-center position-relative">
			<div class="container">
				<div class="copyright">
					© Copyright <strong><span>With Book</span></strong>. All Rights
					Reserved
				</div>
			</div>
	</footer>
