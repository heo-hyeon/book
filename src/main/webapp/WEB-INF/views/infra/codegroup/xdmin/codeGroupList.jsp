	...
	<header id="header" class="header d-flex align-items-center">
		<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
			...
			<nav id="navbar" class="navbar">
				<ul>
					<li><a href="/" class="active">코드그룹관리</a></li>
					<li><a href="/codeList">코드관리</a></li>
		...
		<section id="blog" class="blog">
			<form method="post" action="/codeGroup/codeGroupList" name="formList">
						...
						<c:otherwise>
							<c:forEach items="${list}" var="list" varStatus="status">
								<tr>
									...
									<td>
										<a href="/codeGroup/codeGroupForm?seq=<c:out value="${list.seq}"/>"><c:out value="${list.name}" /></a>
									</td>
									<td>
										<c:out value="${list.name_en}" />
									</td>
									<td>
				...
				<div style="width: 90%; margin: auto;">
					...
					<button class="btn btn-success" type="button" style="float: right; margin-right: 7px;">
						<a href="/codeGroup/codeGroupForm"><i class="fa-solid fa-file-circle-plus"></i></a>
					</button>
				</div>
